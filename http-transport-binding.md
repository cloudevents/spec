...
into the HTTP request or response body as-is, with the `content_type` attribute
...
CloudEvents `content_type` attribute.
...
Examples:
    ...
    * `event_time` maps to `ce-event_time`
    * `event_id` maps to `ce-event_id`
    * `cloud_events_version` maps to `ce-cloud_events_version`
...
ce-cloud_events_version: "0.1"
ce-event_type: "com.example.someevent"
ce-event_time: "2018-04-05T03:56:24Z"
ce-event_id: "1234-1234-1234"
