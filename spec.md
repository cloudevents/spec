...
Protocol Bindings MAY use the message body as the request or response body directly, or MAY embed the message body in another structure. Protocol Bindings MAY batch several message bodies together into a single request or response.
