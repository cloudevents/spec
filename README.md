...
| Pub/Sub Protocol Binding      | [v1.0](https://github.com/cloudevents/spec/blob/v1.0/pubsub-protocol-binding.md) | [master](https://github.com/cloudevents/spec/blob/master/pubsub-protocol-binding.md)  |
